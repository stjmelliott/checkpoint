...
<head>
    <meta charset="UTF-8">
    <title>Exspeedite CheckPoint • Manual Load Wizard</title>
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css/dashboard.css?v=<?php echo time(); ?>">
</head>
<body>
<?php $checkpointHeaderCurrent = 'Manual Load Wizard'; require_once __DIR__ . '/includes/header.php'; ?>

<div class="container py-4" style="max-width: 1100px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0" style="color:#22c55e;">Standalone Manual Load Wizard</h2>
            ...
            <form id="manual-load-form">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-6">
                        ...
                        <input class="form-control" type="tel" name="driver_phone" id="driver_phone" placeholder="+17634446474">
                    </div>
                    <div class="col-12 col-md-6">
...
<script src="js/manual-load.js"></script>
</body>
</html>
